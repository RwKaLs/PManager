...
/**
 * Change MasterPassword Screen
 * If the device has a fingerprint, the user could add it if it wasn't added during first boot
 * Checks for correctness and password length
 */
